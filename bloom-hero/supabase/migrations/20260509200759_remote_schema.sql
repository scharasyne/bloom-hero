...
alter table "public"."vendor_applications" alter column "vendor_type" set data type public.vendor_type using "vendor_type"::text::public.vendor_type;
...
alter table "public"."vendors" alter column "vendor_type" set data type public.vendor_type using "vendor_type"::text::public.vendor_type;
