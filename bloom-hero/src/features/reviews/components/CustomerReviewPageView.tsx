// Source: `src/app/(customer)/review/page.tsx`

import Footer from "@/components/footer";
import { ReviewForm } from "@/features/reviews/components/ReviewForm";
import type { ReviewPageData } from "@/features/reviews/types";

export function CustomerReviewNoOrderView() {
  return (
    <>
...
export function CustomerReviewUnauthenticatedView() {
  return (
    <>
      <main className="min-h-screen flex items-center justify-center bg-[#f5f2eb] px-4">
...
export function CustomerReviewUnavailableView() {
  return (
    <>
      <main className="min-h-screen flex items-center justify-center bg-[#f5f2eb] px-4">
...
type CustomerReviewPageViewProps = {
  orderId: string;
  order: ReviewPageData["order"];
  existingReview: ReviewPageData["existingReview"];
};

export function CustomerReviewPageView({
  orderId,
  order,
  existingReview,
}: CustomerReviewPageViewProps) {
