// Source: `src/app/(customer)/orders/[orderId]/cancel/page.tsx`

type CustomerCancelOrderPageViewProps = {
  submitCancel: (formData: FormData) => Promise<void>;
};

export function CustomerCancelOrderPageView({ submitCancel }: CustomerCancelOrderPageViewProps) {
  return (
