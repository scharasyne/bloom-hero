// Origin: src/lib/utils/vendor-application-validation.ts

import { isValidEmail, normalizeEmail } from "@/lib/utils/email";
import type {
  VendorApplicationStepOneInput,
  VendorApplicationStepTwoInput,
} from "../types";

export function validateVendorApplicationStepOne(
  input: VendorApplicationStepOneInput,
