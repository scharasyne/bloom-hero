...
function SignInButton() {
  return (
    <div className="absolute bg-[#d24b46] bottom-0 content-stretch flex items-center justify-center px-[20px] py-[12px] right-0 rounded-[999px] shadow-[0px_6px_16px_0px_rgba(0,0,0,0.12)] top-0">
      <Link className="flex flex-col font-medium justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white tracking-[0.56px] whitespace-nowrap" href="/sign-in">
  ...
  return (
    <div className="content-stretch flex h-[88px] items-center justify-between relative shrink-0 w-full">
      ...
      <div className="h-[44px] relative shrink-0 w-[394px]">
        <Link className="-translate-x-1/2 absolute bottom-[12px] flex flex-col font-semibold justify-center leading-[0] left-[39px] text-[16px] text-black text-center top-[12px] tracking-[-0.07px] whitespace-nowrap" href="/">
          <p className="cursor-pointer leading-[1.45]">Home</p>
        </Link>
        <Link className="-translate-x-1/2 absolute bottom-[12px] flex flex-col font-semibold justify-center leading-[0] left-[calc(50%-83.5px)] text-[16px] text-black text-center top-[12px] tracking-[-0.07px] whitespace-nowrap" href="/browse-flowers">
        ...
        <Link className="-translate-x-1/2 absolute bottom-[12px] flex flex-col font-semibold justify-center leading-[0] left-[257px] text-[16px] text-black text-center top-[12px] tracking-[-0.07px] whitespace-nowrap" href="/about-us">
