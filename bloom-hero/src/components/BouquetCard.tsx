...
export default function BouquetCard({
  ...
  return (
    <div className="bg-white content-stretch flex flex-col gap-[12px] items-start pb-[24px] relative rounded-[18px] shrink-0" data-name="Bouquet Card">
      ...
      <div className="content-stretch flex flex-col gap-[6px] items-start justify-center px-[16px] relative shrink-0 w-[280px]">
        {/* Name & Price */}
        <div className="content-stretch flex items-start justify-between leading-[0] relative shrink-0 text-center w-full whitespace-nowrap">
        ...
        <div className="bg-[#f3f0ea] content-stretch flex flex-col h-[26px] items-center justify-center px-[10px] py-[4px] relative rounded-[999px] shrink-0">
          ...
          <p className="font-medium text-[#2f5d3a] text-[13px] tracking-[-0.065px] leading-[16px]">{category}</p>
        </div>
        {/* Rating */}
