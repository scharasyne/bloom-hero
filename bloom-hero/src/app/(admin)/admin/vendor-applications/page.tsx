...
function Toast({ message, type }: { message: string; type: "success" | "error" }) {
  return (
    <div
      className={`fixed bottom-[calc(4.5rem+1rem+env(safe-area-inset-bottom,0px))] right-4 left-4 sm:left-auto sm:right-8 md:bottom-8 px-[20px] py-[12px] rounded-[12px] text-white text-[14px] font-semibold shadow-lg z-50 transition-all text-center sm:text-left
