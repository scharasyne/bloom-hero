...
import { getReviewOrderDetails } from "@/features/admin/queries/getReviewOrderDetails";
import { updateReviewStatus } from "@/features/admin/actions/updateReviewStatus";
import type {
...
function OrderDetailContent({ details }: { details: ReviewOrderDetails }) {
  return (
...
export default function ReviewModerationPage() {
  ...
  const [orderDetails, setOrderDetails] = useState<ReviewOrderDetails | null>(null);
  ...
  return (
    <div className="flex flex-col gap-[32px]">
      <div>
        <h1 className="font-semibold text-2xl sm:text-3xl lg:text-[40px] text-[#2c2a28] leading-tight lg:leading-[48px]">
          Review Moderation
        </h1>
