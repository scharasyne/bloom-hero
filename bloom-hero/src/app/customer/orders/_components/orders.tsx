...
// All data fetching happens here on the server; only PaymentCountdown
// (imported transitively via OrderCard) runs on the client.

import { createSupabaseServerClient } from "@/lib/supabase/server-client";
import NavBar from "@/components/navbar";
import Footer from "@/components/footer";
import { OrderCard } from "@/app/customer/orders/_components/order-card";
import { TABS } from "@/app/customer/orders/_lib/constants";
import { groupOrders } from "@/app/customer/orders/_lib/utils";
import type { OrderItemRow } from "@/app/customer/orders/_lib/types";
import { TAB_STATUS_MAP, EMPTY_STATE } from "@/app/customer/orders/_lib/constants";
import type { TabKey } from "@/app/customer/orders/_lib/constants";
      ...
      <>
        ...
        <main className="min-h-screen flex items-center justify-center bg-[#fbf7f4] px-4">
          <div className="bg-white rounded-2xl shadow-lg border border-[#e6e2dd] px-8 py-10 text-center max-w-md w-full">
            ...
            <p className="text-sm text-[#6D6863] mb-6">
                ...
                return (
                  <a
                    ...
                    className={[
                      ...
                      isActive
                        ? "bg-[#D24B46]/10 text-[#D24B46] border border-[#D24B46]/25"
