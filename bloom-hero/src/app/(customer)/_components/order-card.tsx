  ...
  if (activeTab === "to-pay") {
    return (
      <div className="flex flex-col gap-3 w-full sm:w-auto">
        {/* FIX 7: Countdown left-aligned, actions right-aligned ΓÇö no more floating center */}
        ...
        <div className="flex items-center gap-2.5 justify-end flex-wrap">
          ...
          {/*
            FIX 6: Cancel Order has stronger destructive visual weight ΓÇö
          ...
          */}
          ...
          {/* FIX 2: Pay Now ΓåÆ solid red, customer primary CTA */}
          <a
  ...
  if (activeTab === "to-receive") {
    return (
      <div className="flex items-center gap-2.5 justify-end flex-wrap">
        ...
        {/* Order Received ΓÇö positive confirmation action, red as customer primary */}
        <a
...
export function OrderCard({ order, activeTab }: { order: OrderGroup; activeTab: TabKey }) {
  /*
    ...
    which reads as "5 items" when it's really 1 product ├ù qty 5.
    Now shows distinct product count ΓÇö e.g. "1 product" or "3 products".
