...
export default async function VendorMarketProfilePage() {
  ...
  return (
    <main className="mx-auto max-h-[calc(100vh-80px)] w-full max-w-6xl snap-y snap-mandatory overflow-y-auto scroll-smooth px-5 py-8 sm:px-8 lg:px-12">
      <section className="snap-start px-4 py-6 sm:px-8">
        ...
        <section id="bouquets" className="mt-8 snap-start scroll-mt-8">
        ...
        <section id="reviews" className="mt-14 snap-start scroll-mt-8">
        ...
        <section id="about" className="mt-14 snap-start scroll-mt-8">
