...
export default async function VendorProfilePage() {
  ...
  return (
    <VendorPageShell activeTab="profile" businessType={commonProfile.businessType}>
      <section className="w-full">
        ...
        <div className="space-y-14 pt-8">
          ...
          <section id="about" className="mb-10 scroll-mt-20 md:mb-16">
          ...
          <div className="border-t border-[#edeae6] pt-6 md:hidden">
            <Link
              href="/vendor/settings"
              className="flex w-full items-center justify-center gap-2 rounded-2xl border border-[#e0d8cf] bg-white px-4 py-3 text-sm font-semibold text-[#2f5d3a] transition-colors hover:bg-[#f3eee8]"
            >
